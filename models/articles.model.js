...
// exports.fetchArticles = (sort_by, order, topic, author, limit = 10, p = 1) => {
...
//   if (topic) {
//     countWhereClause += ` WHERE articles.topic = $${
...
//   if (author) {
//     if (totalCountParams.length > 0) {
//       countWhereClause += ` AND articles.author = $${
//         totalCountParams.length + 1
//       }`;
//     } else {
//       countWhereClause += ` WHERE articles.author = $${
//         totalCountParams.length + 1
//       }`;
//     }
...
//   const finalTotalCountQuery = totalCountQuery + countWhereClause;
...
//         db.query(finalTotalCountQuery, totalCountParams),
//       ]);
//     })
